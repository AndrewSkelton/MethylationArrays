...
lvcm.design <- model.matrix(~SampleType:mAge + Data_Source)
...
#      SampleTypePreserved_OA_Knee,     file = "mAge_Lists.RData")
  
  assign(lvcm.name, 
         lvcm.filter)
}
save(all, oa_only, hip_only, knee_only, file = "mAge_Collapse_Lists.RData")
