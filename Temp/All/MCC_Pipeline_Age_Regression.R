...
#  Description : Linear Variable Covariate Model - A Tad more Complex                       |
#-------------------------------------------------------------------------------------------#
...
# lvcm.design <- model.matrix(~SampleType:Age + Data_Source)
...
# }
mAdj.in.age     <- minfi::getM(lvcm.in)
mAdj.fit.age    <- lvcm.fit$coefficients[,-c(6:10)]
